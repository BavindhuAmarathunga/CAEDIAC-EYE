...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i><a href="history.php">Patient History</a>
                            </li>
                        </ol>
                    </div>
                </div>
  ...
  <tr>
    <th>Viewed Details</th>
    <th>Viewed Date</th>
    <th>Enterd Details</th>
    <th>Enterd Date</th>
  </tr>
  <tr>
    <td>John Doe </td>
    <td>(25/03/2020 , 12:45)</td>
    <td>John Doe</td>
    <td>(5/03/2020 , 12:45)</td>
  </tr>
  <tr>
    <td>John Doe </td>
    <td>(5/03/2020 , 02:45)</td>
    <td>John Doe  </td>
    <td>(5/03/2020 , 12:45)</td>
  </tr>
  <tr>
    <td>John Doe</td>
    <td>(5/03/2020 , 21:25)</td>
    <td>John Doe </td>
    <td>(5/03/2020 , 12:45)</td>
